...
price[] = [2,5,7,8,10]
Output: 12
Explanation: The maximum obtainable value is 12 by cutting the rod into two pieces of lengths 2 and one of  length 1.
2+5+5=12
...
f(ind,W)-> Maximum value of items thief can steal from index 0 to ind with capacity W of the knapsack.
