...
//Using Tabulation
int maximumProfit_Tab(vector<int>& Arr, int n, int k) {
...
int maxProfit_SO(vector<int>& Arr, int n, int k) {
...
int main() {
    ...
    cout << "The maximum profit that can be generated is " << maximumProfit(prices, n, k) << endl;//Using Memoization
    cout << "The maximum profit that can be generated is " << maximumProfit_Tab(prices, n, k) << endl;//Using Tabulation
    cout << "The maximum profit that can be generated is " << maxProfit_SO(prices, n, k) << endl;//Using Space Optimization
    return 0;
}
